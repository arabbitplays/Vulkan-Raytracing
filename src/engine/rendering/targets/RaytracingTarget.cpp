...
namespace RtEngine {
    RaytracingTarget::RaytracingTarget(const std::shared_ptr<ResourceBuilder> &resource_builder, uint32_t max_frames_in_flight) : RenderTarget(resource_builder, max_frames_in_flight) {}
