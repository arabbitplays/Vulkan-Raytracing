...
namespace RtEngine {
	...
	GuiRenderer::GuiRenderer(std::shared_ptr<VulkanContext> context) : context(context) {
	...
	void GuiRenderer::createFrameBuffers(VkDevice device, std::shared_ptr<Swapchain> swapchain) {
	...
	void GuiRenderer::initImGui(std::shared_ptr<DeviceManager> device_manager, GLFWwindow *window,
	...
	void GuiRenderer::recordGuiCommands(VkCommandBuffer commandBuffer, uint32_t imageIndex) {
